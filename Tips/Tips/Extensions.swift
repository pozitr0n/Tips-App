...
public extension UIDevice {
    ...
    static let currentmModelName: String = {
...
extension UITextField {
    ...
    // Maximum length of the string in bill total UITextField
    //
    @IBInspectable var maximumLength: Int {
        ...
        set {
            ...
            self.addTarget(self, action: #selector(checkMaximumLength), for: .editingChanged)
        }
    ...
    @objc func checkMaximumLength(textField: UITextField) {
        
        guard !self.isInputMethod(),
              let prospectiveText = self.text,
              prospectiveText.count > maximumLength
        else {
            return
        }
        
        let selection = selectedTextRange
        let maxCharIndex = prospectiveText.index(prospectiveText.startIndex, offsetBy: maximumLength)
